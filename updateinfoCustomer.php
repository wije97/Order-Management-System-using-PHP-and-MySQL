<?php
	...
	if ($logtype == "customer") {
		$sql = "SELECT * FROM tbl_customer WHERE C_NIC = '$nics'";
	...
	if(isset($_POST['submit'])){
		...
		$address = $_POST['address'];
			...
			$insert1 = "UPDATE `tbl_customer` SET C_First_Name='$fname', C_Last_Name='$lname', C_gender='$gender', C_age='$age', C_phone='$telephone', C_email='$email', C_address='$address' WHERE C_NIC='$nics'";
			...
			if($query == 1){		
				...
				if($usertype == "customer"){
					...
					window.location.href = "updateinfoCustomer.php";</script>';
				}
			}
			else{
	...
	if(isset($_POST['back'])){
		if($usertype == "customer"){
			echo '<script type="text/javascript">window.location.href = "customer/Customer_UI.php";</script>';
		}else {
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#flights" aria-controls="flights" role="tab" data-toggle="tab"><?php if($usertype == "admin") {?> View Customer Details <?php }else {?> Update Your Details <?php }  ?></a>
								      </li>
