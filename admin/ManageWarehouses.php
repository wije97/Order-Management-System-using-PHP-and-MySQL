	...
	<body>
		...
		<div class="fh5co-section-gray">
			<br>
				...
				<tr> 
				  ...
				  <th><a class="btn btn-success" href="addWarehouse.php">Add New Warehouse<i class="icon-arrow-right22"></i></a></th>
				</tr>
				</form>
				</table>
							...
							if ($result = mysqli_query($con,$sql)) {
								if(mysqli_num_rows($result)>0){
									...
									while ($row = $result->fetch_assoc()) {
								        ...
								        <input type="hidden" name="hwid" value="'.$wCode.'"></td>
		...
		<?php
			if(isset($_POST['view'])){
				...
				$_SESSION["wcode"] = $_POST['hwid'];
				header("Location:updateinfoWarehouse.php");
			...
			if(isset($_POST['delete'])){
				...
				$qupdate = mysqli_query($con,"DELETE FROM `tbl_warehouse` WHERE Warehouse_Code = '$key'") or die("Action not successful".mysql_error());
