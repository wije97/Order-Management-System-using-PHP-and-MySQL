<?php
	...
	$result = mysqli_query($con, "SELECT * FROM tbl_staff_member WHERE S_NIC= '$u_nic' AND S_status='Approved'");
	...
	$sql = "SELECT * FROM tbl_notification WHERE AuthStatus ='1'";
	...
	$sql2 = "SELECT * FROM tbl_order WHERE O_status ='Pending'";
		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a <?php if($approvedUser == "Y") {?> href="../index.php" <?php } ?>>AgroFarm</a></h1>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="../images/place-15.jpg" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>View Products</h3>
								<a class="btn btn-primary btn-outline" <?php if($approvedUser == "Y") {?> href="../index.php" <?php } ?>>See Now<i class="icon-arrow-right22"></i></a>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img <?php if($rowcount2 > 0) {?> src="../images/place-14-red.jpg" <?php }else {?> src="../images/place-14-grey.jpg" <?php }  ?> class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Manage Orders</h3>
								<a class="btn btn-primary btn-outline" <?php if($approvedUser == "Y") {?> href="../ManageOrders.php" <?php } ?>>See Now<i class="icon-arrow-right22"></i></a>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img <?php if($rowcount > 0) {?> src="../images/place-17-red.jpg" <?php }else {?> src="../images/place-17-grey.jpg" <?php }  ?> class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Notification</h3>
								<a class="btn btn-primary btn-outline" <?php if($approvedUser == "Y") {?> href="../NotificationPage.php"<?php } ?>>See Now<i class="icon-arrow-right22"></i></a>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="../images/place-16.jpg" class="img-responsive">
							<div class="desc">
								...
								<a class="btn btn-primary btn-outline" <?php if($approvedUser == "Y") {?> href="../ManageProducts.php" <?php } ?>>See Now<i class="icon-arrow-right22"></i></a>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="../images/place-12.jpg" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>View Warehouses</h3>
								<a class="btn btn-primary btn-outline" <?php if($approvedUser == "Y") {?> href="ViewWareHouses.php" <?php } ?>>See Now<i class="icon-arrow-right22"></i></a>
							</div>
						</div>
					</div>
