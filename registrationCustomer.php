...
if(isset($_POST['submit'])){
	...
	if($password != $Cpassword){
		...
		$insert1="INSERT INTO `tbl_customer` (C_NIC, C_First_Name, C_Last_Name, C_gender, C_age, C_address, C_email, C_phone) VALUES ('$nic','$fname','$lname','$gender','$age','$address','$email','$telephone')";

		$query = mysqli_query($con, $insert1) or die(mysqli_error($con));
		if($query == 1){	
				$insert2="INSERT INTO `tbl_customer_login` (`CL_CusNIC`, `C_username`, `C_password`) VALUES ('$nic','$username','$password')";
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#flights" aria-controls="flights" role="tab" data-toggle="tab">Customer Registration</a>
								      </li>
